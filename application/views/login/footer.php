 ...
 <script src="<?= base_url('assets/assets_login1/vendor/jquery/jquery-3.2.1.min.js') ?>"></script>
  ...
  <script src="<?= base_url('assets/assets_login1/vendor/bootstrap/js/bootstrap.min.js') ?>"></script>
   ...
   <script src="<?= base_url('assets/assets_login1/vendor/select2/select2.min.js') ?>"></script>

  <script src="<?= base_url('assets/assets_login1/vendor/daterangepicker/moment.min.js') ?>"></script>

  <script src="<?= base_url('assets/assets_login1/vendor/daterangepicker/daterangepicker.js') ?>"></script>
