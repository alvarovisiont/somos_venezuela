...
<div class="row no-gutters">
    <div class="col-md-12 col-sm-12 pull-right">
    	...
    	<button class="btn btn-app btn-purple" data-toggle="modal" data-target="#modal_censados_estado">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content modal-lg">
            <div class="modal-header modalHeader">
                ...
                <h4 class="modal-title text-center">Centros Medicos del Estado Sucre&nbsp;<i class="fa fa-hospital-o"></i></h4>
            </div>
...
<div id="modal_registradores" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header modalHeader">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title text-center">Registradores del Estado Sucre&nbsp;<i class="fa fa-hospital-o"></i></h4>
            </div>
            <div class="modal-body">
            	<div class="row no-gutters">
            		<div class="col-sm-12 col-md-12">
...
<div id="modal_medicos" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header modalHeader">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title text-center">Medicos del Estado Sucre&nbsp;<i class="fa fa-hospital-o"></i></h4>
            </div>
            <div class="modal-body">
            	<div class="row no-gutters">
            		<div class="col-sm-12 col-md-12">
...
<div id="modal_censados_estado" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width: 100%">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modalHeader">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title text-center">Censados del Estado Sucre&nbsp;<i class="fa fa-hospital-o"></i></h4>
            </div>
            <div class="modal-body">
            	<div class="row no-gutters">
            		<div class="col-sm-12 col-md-12">
