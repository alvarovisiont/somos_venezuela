<script>
	$(function($){
		...
		$('#modal_centros').on('show.bs.modal', function(e){
			...
			$.ajax({
				url: '<?= base_url()."index.php/dashboard/centros_estados_modal" ?>',
				type: 'GET',
				dataType: 'JSON',
				data: {},
			})
		...
		$('#modal_registradores').on('show.bs.modal', function(e){
			...
			$.ajax({
				url: '<?= base_url()."index.php/dashboard/registradores_medicos_estados_modal" ?>',
				type: 'GET',
				dataType: 'JSON',
				data: {permiso: 9},
			})
		...
		$('#modal_censados_estado').on('show.bs.modal', function(e){
			...
			$.ajax({
				url: '<?= base_url()."index.php/dashboard/censados_estado_modal" ?>',
				type: 'GET',
				dataType: 'JSON',
				data: {permiso: 8},
			})
