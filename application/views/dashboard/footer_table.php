...
<![endif]-->
		...
		<script src="<?= base_url('assets_sistema/js/jquery.jqGrid.min.js') ?>"></script>
		<script src="<?= base_url('assets_sistema/js/grid.locale-en.js') ?>"></script>
		...
		<script type="text/javascript">
			var grid_data = 
			[ 
				{id:"1",name:"alvaro",note:"note",stock:"Yes",ship:"FedEx", sdate:"2007-12-03"},
