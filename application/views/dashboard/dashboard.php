 <div class="col-xs-12 col-sm-6">
						<div class="widget-box">
							<div class="widget-header">
								<h4 class="widget-title">Estandar/ Configuracion</h4>
							</div>	
												...
												<div class="timeline-items">
													<div class="timeline-item clearfix">
														<div class="timeline-info">
															<span class="timeline-date">Controllers</span>
															...
															<div class="widget-body">
																<div class="widget-main no-padding">
																	<span class="bigger-110">
																		<a href="#" class="purple bolder">Acción</a>
																	</span>

																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
																	<a href="#">index &hellip;</a>
																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
																	<a href="#">Create &hellip;</a>
																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
																	<a href="#">Store &hellip;</a>
																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
																	<a href="#">Edit &hellip;</a>
																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
																	<a href="#">Update &hellip;</a>
																	<br />
																	<i class="ace-icon fa fa-hand-o-right grey bigger-125"></i>
													...
													<div class="timeline-item clearfix">
														<div class="timeline-info">
															<span class="timeline-date">Model</span>
